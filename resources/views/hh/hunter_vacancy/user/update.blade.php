...
<x-seo.meta
    ...
    description="Редактировать вакансию"
    keywords="Редактировать вакансию"
/>
@section('content')
    <section>
        <div class="block block_content cabinet_user hh">
            <div class="block_content__breadcrumbs">
                {{ Breadcrumbs::render('my_vacancy_edit', $item) }}
            </div>

            <x-cabinet.title
                title="Мой профиль"
                :subtitle="(isset($user->UserHuman->title))?$user->UserHuman->title:'' "
                mini="Редактировать вакансию"
            />
            ...
            <div class="block_content__flex reverse">
                ...
                <div class="block_content__right">
                    <x-form.form action="{{ route('my_vacancy_update', $item->id) }}" enctype="multipart/form-data" :put="true">
