<div class="menu_hamburger-component">
    <div class="h_toggle app_h_toggle">
        <img alt="menu_hamburger" class="h_img app_h_open active" width="24" height="24"
        ...
        <img alt="menu_hamburger" class="h_img app_h_close" width="24" height="24"
    ...
    <div class="app_add_hm add_hm">
        <div class="add_hm__flex relative">
            <div class="add_hm__left">
                <x-menu.hamburger-menu-component/>
            </div>
