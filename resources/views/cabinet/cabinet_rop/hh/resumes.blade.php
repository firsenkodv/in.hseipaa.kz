...
@php
    $isModer = request()->routeIs('rop_hh_resumes_moder', 'rop_hh_resume_moder');
    $pageTitle = $isModer ? 'Резюме на модерации' : 'Резюме';
    $breadcrumb = $isModer ? 'rop_hh_resumes_moder' : 'rop_hh_resumes';
@endphp
<x-seo.meta
    :title="$pageTitle"
                        ...
                        <div class="cabinet__users">
                            ...
                            @if(count($items))
                                ...
                                @foreach($items as $item)
                                    <a href="{{ route($isModer ? 'rop_hh_resume_moder' : 'rop_hh_resume', $item->id) }}" class="user_user-list-item u_teaser">
                                        <div class="username">
                                            @if($item->published)
