...
/**
 * @extends ModelResource<CompanyItem>
 */
class CompanyItemResource extends ModelResource
{
    protected string $model = CompanyItem::class;
    ...
    public function indexFields(): array
    {
        return [
           ...
           /* Image::make(__('Изображение'), 'img'),*/
            ...
            BelongsTo::make('Категория', 'category', 'title', resource: CompanyCategoryResource::class),
