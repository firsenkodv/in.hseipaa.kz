...
/**
 * @extends ModelResource<HunterResumeItem>
 */
class HunterResumeItemResource extends ModelResource
{
    protected string $model = HunterResumeItem::class;

    protected string $title = 'Резюме';
    ...
    public function indexFields(): array
    {
        return [
            ...
            Number::make('Желаемая зарплата', 'price'),
        ...
        return [
            Box::make([
                Tabs::make([
                        ...
                        Grid::make([
                            ...
                            Column::make([
                                ...
                                Collapse::make('Детали вывода', [
                                    ...
                                    Number::make('Желаемая зарплата', 'price')->hint('Только цифры'),
                                ]),
                    ...
                    Tab::make(__('О соискателе'), [
                        Grid::make([
                            Column::make([

                                Collapse::make('Текущее место работы', [
                                    Text::make('Компания', 'company'),
                                ...
                                Collapse::make('Контакты', [
                                    ...
                                    Number::make('Телефон', 'phone')->hint('Указывайте только номер, без + и пробелов - 77075594060'),
                    ...
                    Tab::make(__('Детали резюме'), [
                        Grid::make([
                            Column::make([

                                Collapse::make('О себе', [
                                    TinyMce::make('Описание', 'desc'),
                                ]),

                                Collapse::make('Навыки и требования', [
                                    TinyMce::make('Навыки / требования', 'must'),
                                ]),

                                Collapse::make('Пожелания', [
                                    TinyMce::make('Пожелания к условиям', 'conditions'),
                                ]),
