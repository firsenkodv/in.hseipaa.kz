...
/**
 * @extends ModelResource<UsefulItem>
 */
class UsefulItemResource extends ModelResource
{
    protected string $model = UsefulItem::class;
    ...
    public function indexFields(): array
    {
        return [
          ...
          /*  Image::make(__('Изображение'), 'img'),*/
            ...
            BelongsTo::make('Категория', 'subcategory', 'title', resource: UsefulSubcategoryResource::class),
