...
/**
 * @extends ModelResource<UserProduction>
 */
class UserProductionResource extends ModelResource
{
    protected string $model = UserProduction::class;


    protected string $title = 'Вид деятельности компании';
