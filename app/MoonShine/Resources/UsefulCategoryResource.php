...
/**
 * @extends ModelResource<UsefulCategory>
 */
class UsefulCategoryResource extends ModelResource
{
    protected string $model = UsefulCategory::class;

    protected string $title = 'Категория Полезного';
...
/*    protected ?ClickAction $clickAction = ClickAction::EDIT;*/
    ...
    public function indexFields(): array
    {
       ...
       /*     Image::make(__('Изображение'), 'img'),*/
            ...
            BelongsTo::make('Раздел', 'useful', 'title', resource: UsefulResource::class),
