...
/**
 * @extends ModelResource<UserHuman>
 */
class UserHumanResource extends ModelResource
{
    protected string $model = UserHuman::class;

    protected string $title = 'Физ/Юр лица';
