...
/**
 * @extends ModelResource<UsefulSubcategory>
 */
class UsefulSubcategoryResource extends ModelResource
{
    protected string $model = UsefulSubcategory::class;

    protected string $title = 'Подкатегория';
    ...
    public function indexFields(): array
    {
        return [
           ...
           /* Image::make(__('Изображение'), 'img'),*/
            ...
            BelongsTo::make('Категория', 'category', 'title', resource: UsefulCategoryResource::class),
