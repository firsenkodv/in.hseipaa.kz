...
/**
 * @extends ModelResource<SiteNewItem>
 */
class SiteNewItemResource extends ModelResource
{
    ...
    public function indexFields(): array
    {
        return [
           ...
           /* Image::make(__('Изображение'), 'img'),*/
            ...
            BelongsTo::make('Категория', 'category', 'title', resource: SiteNewResource::class),
                        ...
                        Grid::make([
                            ...
                            Column::make([
                                ...
                                Collapse::make('Детали вывода', [
                                    Date::make('Дата', 'created_at')->withTime()->default(date('Y-m-d H:i:s')),
                                    BelongsTo::make('Категория', 'category', 'title', resource: SiteNewResource::class),
