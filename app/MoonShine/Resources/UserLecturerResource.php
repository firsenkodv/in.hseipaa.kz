...
/**
 * @extends ModelResource<UserLecturer>
 */
class UserLecturerResource extends ModelResource
{
    protected string $model = UserLecturer::class;

    protected string $title = 'Лекторы';
