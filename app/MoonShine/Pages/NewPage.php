...
class NewPage extends Page
{
    ...
    public function setting()
    {
        ...
        if (Storage::disk('config')->exists('moonshine/new.php')) {
            $result = include(storage_path('app/public/config/moonshine/new.php'));
        } else {
            $result = null;
        }
    ...
    {
        return $this->title ?: 'Раздел новости';
    }
    ...
    protected function components(): iterable
    {
        ...
        return [
            FormBuilder::make('/moonshine/new', FormMethod::POST)
                ->fields([

                    Tabs::make([

                        Tab::make(__('Раздел новости'), [
                            ...
                            Grid::make([
                                ...
                                Column::make([
                                    Divider::make('Описание раздела новости'),
